...
- printing-press-library: [issue #501](https://github.com/mvanhorn/printing-press-library/issues/501) → [merged fix #539](https://github.com/mvanhorn/printing-press-library/pull/539) — `instacart-pp-cli` sending invalid `{0,0}` coordinates pair to `ShopCollectionScoped`, breaking every search/add/cart-show with "no shops"
